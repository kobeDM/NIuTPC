...
int NIuTPCReader0::set_window_size(std::string ip_address, int window_size)
{
    SitcpRbcp bcp;
...
int NIuTPCReader0::set_packet_id(std::string ip_address, int module_num)
{
    SitcpRbcp bcp;
...
int NIuTPCReader0::set_delay(std::string ip_address, int delay)
{
    SitcpRbcp bcp;
...
int NIuTPCReader0::set_thinning(std::string ip_address, int thinning)
{
    SitcpRbcp bcp;
