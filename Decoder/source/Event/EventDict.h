/********************************************************************
* /nadb16/0.1c/DecoderMulti0.0/src/Event/EventDict.h
* CAUTION: DON'T CHANGE THIS FILE. THIS FILE IS AUTOMATICALLY GENERATED
*          FROM HEADER FILES LISTED IN G__setup_cpp_environmentXXX().
*          CHANGE THOSE HEADER FILES AND REGENERATE THIS FILE.
********************************************************************/
#ifdef __CINT__
#error /nadb16/0.1c/DecoderMulti0.0/src/Event/EventDict.h/C is only for compilation. Abort cint.
#endif
#include <stddef.h>
#include <stdio.h>
#include <stdlib.h>
...
#include "/nadb16/0.1c/DecoderMulti0.0/include/Event.h"
#include <algorithm>
namespace std { }
using namespace std;
