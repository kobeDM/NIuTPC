...
int main(int argc,char *argv[]){
	...
	*/
	...
	//---------------Write--------------------
	std::string outfilename = filename.substr(0,index) + "_height.root";
